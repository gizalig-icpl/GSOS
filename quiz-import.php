...
<div class="page-content">
            <div class="content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3"><em class="bi bi-ui-radios-grid"></em><?php echo " "; echo _Quiz; ?></div>
                    <div class="ps-3">
                ...
                <div class="main-title card p-2" >
                    <h2 class="mb-0 text-success"><?php echo _Quiz; echo " - "; echo _Import;?></h2>
	        	</div>
				...
				<div>
                    <?php
                        if(isset($_SESSION['quiz-status']) && !empty($_SESSION['quiz-status'])){
                            if($_SESSION['quiz-status'] == "success"){
                ...
                <div class="kpi-form">
                    <div class="row g-3">
                        <form  action="quiz-import-data.php" method="POST" enctype="multipart/form-data">
                            <ul class="mt-2">
                                <li>
                                    <?php echo _Please_upload_the_excel_file_in_the_given_format_only; ?> <a href="./quiz_import/quiz.xlsx">(quiz.xlsx)</a>
                                </li>
                                <li>
                            ...
                            <label class="form-label file-upload">
                                ...
                                <input class="form-control form-control-sm" type="file" id="fileToUpload"  name="fileToUpload" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"  required>
                            </label>
                            <!-- <button type="submit" class="submit-btn"><?php echo _Submit; ?></button> -->
                            <button type="submit" class="btn btn-primary btn submit-btn"><?php echo _Submit; ?></button>
                        </form>
                    </div>
                </div>
                </div>
