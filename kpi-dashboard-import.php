                ...
                <div class="card">
                    <div class="card-body">
                        <div class="border p-3 rounded">
                            ...
                            <div class="kpi-form">
                                <div class="row">
                                    <form action="kpi-import-data.php" method="POST" enctype="multipart/form-data">
                                        <ul class="mt-2">
                                            <li>
                                                <?php echo _Please_upload_the_excel_file_in_the_given_format_only; ?> <a href="./kpi_import/kpi.xlsx">(kpi.xlsx)</a>
                                            </li>
                                            <li>
