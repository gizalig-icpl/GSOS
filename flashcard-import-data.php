            ...
            <div class="container-fluid">
                ...
                <div class="main-title card p-2">
                    <div class="d-flex align-items-center">
                        <h2 class="text-success">Flash Card - Import</h2>
                        <div class="ms-auto">
                            <form action="./domain/index.php?page=flashcard-import-db" method="POST">
                                <input hidden type="text" name="fileName" value="<?php echo filter($target_file); ?>">
                                <button type="submit" class="submit-btn btn btn-sm bg-primary" style="color:#fff" name="send" value=" Submit"  onClick="displayLoader()" >Upload</button>
                            ...
                            for ($l = 0; $l < count($names); $l++) {
                                ...
                                for ($i = 1; $i <= $end_row; $i++) {
                                    if (is_numeric($data[$i]['A'])) {
                                        ...
                                        $tmpArr['Answer'] = (gettype($data[$i]['D']) == "boolean" ? json_encode($data[$i]['D']) : $data[$i]['D']);
